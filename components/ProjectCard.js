        ...
        <div className="flex gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
          ...
          {project.detailUrl && (
            <Link href={project.detailUrl}>
              <span className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 transition-colors cursor-pointer">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
